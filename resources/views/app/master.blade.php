...
<head>
    ...
    <title>Themplus - Sua Igreja</title>
    <!-- Favicon icon -->
    ...
    <div id="main-wrapper">
        ...
        <div class="nav-header">
            <a href="index.html" class="brand-logo">
				...
				<div class="brand-title">Themplus</div>
            </a>
                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item dropdown header-profile">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <a href="{{ route('app.logout')}}" class="dropdown-item ai-icon">
        ...
        <div class="deznav">
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
                    <li><a class="ai-icon" href="{{ route('app.dashboard')}}" aria-expanded="false">
                            <i class="flaticon-025-dashboard"></i>
                            <span class="nav-text">Dashboard</span>
                        </a>
                    </li>
                    <li><a href="{{ route('app.membros')}}" class="ai-icon" aria-expanded="false">
                            <i class="flaticon-044-menu"></i>
                            <span class="nav-text">Membros</span>
                        </a>
                    </li>
                    <li><a href="{{ route('app.financeiro')}}" class="ai-icon" aria-expanded="false">
                            <i class="flaticon-041-graph"></i>
                            <span class="nav-text">Financeiro</span>
                        </a>
                    </li>
                    <li><a href="{{ route('app.eventos')}}" class="ai-icon" aria-expanded="false">
                            <i class="flaticon-381-push-pin"></i>
                            <span class="nav-text">Eventos</span>
                        </a>
                    </li>
                    <li><a class="ai-icon" href="{{ route('app.escola-biblica')}}" aria-expanded="false">
                            <i class="flaticon-381-notepad-2"></i>
                            <span class="nav-text">Escola Bíblica</span>
                        </a>
                    </li>
                    <li><a class="ai-icon" href="{{ route('app.celulas')}}" aria-expanded="false">
                            <i class="flaticon-381-share"></i>
                            <span class="nav-text">Células</span>
                        </a>
                    </li>
                    <li><a class="ai-icon" href="{{ route('app.ministerios')}}" aria-expanded="false">
                            <i class="flaticon-045-heart"></i>
                            <span class="nav-text">Ministérios</span>
                        </a>
                    </li>
                    <li><a class="ai-icon" href="{{ route('app.igreja')}}" aria-expanded="false">
				...
				<div class="copyright">
					<p><strong>Themplus</strong> © <?= date("Y"); ?> All Rights Reserved</p>
				</div>
			</div>
        </div>
        <!--********************************** Sidebar end ***********************************-->
